...
= 2.3.0 =
* Fixed various bugs
* Update compability to WordPress 4.8

= 2.2.9 =
* Minor fix
* Update compability to WordPress 4.6

= 2.2.8 =
* Fix conflict with imagesLoaded

= 2.2.7 =
* Fixing security issues
* Fix CSRF bug, found by Jouko Pynnonen (https://klikki.fi)
